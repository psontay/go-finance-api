...
// Source: SimpleBank/database/sqlc (interfaces: Store)
//
...
func (m *MockStore) GetUserForUpdate(ctx context.Context, username string) (sqlc.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccountsOwner(ctx context.Context, arg sqlc.ListAccountsOwnerParams) ([]sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAccountsOwner", ctx, arg)
	ret0, _ := ret[0].([]sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListAccountsOwner(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAccountsOwner", reflect.TypeOf((*MockStore)(nil).ListAccountsOwner), ctx, arg)
}
